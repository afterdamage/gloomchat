...
Future<void> notificationTap(
  ...
  final payload = GloomChatPushPayload.fromString(
  ...
  switch (notificationResponse.notificationResponseType) {
    ...
    case NotificationResponseType.selectedNotificationAction:
      final actionType = GloomChatNotificationActions.values.singleWhereOrNull(
      ...
      switch (actionType) {
        ...
        case GloomChatNotificationActions.mute:
          await room.setPushRuleState(PushRuleState.mentionsOnly);
      }
  }
}

enum GloomChatNotificationActions { markAsRead, reply, mute }
