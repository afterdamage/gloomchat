...
Future<void> pushHelper(
  ...
  try {
    ...
    await flutterLocalNotificationsPlugin.show(
      ...
      title: l10n.newMessageInGloomChat,
  ...
  final androidPlatformChannelSpecifics = AndroidNotificationDetails(
    ...
    actions: event.type == EventTypes.RoomMember || !useNotificationActions
        ...
        : <AndroidNotificationAction>[
            AndroidNotificationAction(
              GloomChatNotificationActions.reply.name,
              l10n.reply,
              inputs: [
            ...
            AndroidNotificationAction(
              GloomChatNotificationActions.markAsRead.name,
              l10n.markAsRead,
              semanticAction: SemanticAction.markAsRead,
            ),
            AndroidNotificationAction(
              GloomChatNotificationActions.mute.name,
              l10n.mute,
...
class GloomChatPushPayload {
  final String? clientName, roomId, eventId;

  GloomChatPushPayload(this.clientName, this.roomId, this.eventId);

  factory GloomChatPushPayload.fromString(String payload) {
    final parts = payload.split('|');
    if (parts.length != 3) {
      return GloomChatPushPayload(null, null, null);
    }
    return GloomChatPushPayload(parts.first, parts[1], parts[2]);
  }
