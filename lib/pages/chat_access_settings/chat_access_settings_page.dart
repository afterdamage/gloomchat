              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      for (final historyVisibility in HistoryVisibility.values)
                        RadioListTile<HistoryVisibility>(
                          title: Text(
                ...
                if ({
                  ...
                  FutureBuilder(
                    ...
                    builder: (context, snapshot) => SquareSwitchListTile(
                ...
                ListTile(
                  ...
                  trailing: IconButton(
                    ...
                    onPressed: () => GloomShare.share(room.id, context),
                  ),
                ),
                ListTile(
...
class _AliasListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      title: InkWell(
        onTap: () => GloomShare.share('https://matrix.to/#/$alias', context),
