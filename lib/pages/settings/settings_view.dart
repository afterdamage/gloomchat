        ...
        child: ListView(
          ...
          children: <Widget>[
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          TextButton.icon(
                            onPressed: () => GloomShare.share(mxid, context),
            ...
            ListTile(
              ...
              title: Text(L10n.of(context).advancedSettings),
              subtitle: Text(L10n.of(context).advancedSettingsDescription),
              onTap: () => context.go('/rooms/settings/advanced'),
              tileColor: activeRoute.startsWith('/rooms/settings/advanced')
                  ? theme.colorScheme.surfaceContainerHigh
                  : null,
            ),
            // About section
            ...
            ListTile(
              ...
              title: Text(L10n.of(context).optOutOfFree),
              onTap: () => launchUrlString('https://ko-fi.com/afterdamage'),
            ),
            ListTile(
