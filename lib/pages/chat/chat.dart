...
class ChatController extends State<ChatPageWithRoom>
  ...
  // ── Kinetic Ledger (Message Physics) ──────────────────────────────────
  bool physicsLocked = true;
  void togglePhysicsLock() => setState(() => physicsLocked = !physicsLocked);
      ...
      children: [
        ...
        ValueListenableBuilder(
          ...
          builder: (context, displayChatDetailsColumn, _) =>
              !GloomThemes.isThreeColumnMode(context) ||
                  room.membership != Membership.join ||
                  !displayChatDetailsColumn
              ? const SizedBox(height: double.infinity, width: 0)
              : Container(
                  width: GloomThemes.columnWidth,
